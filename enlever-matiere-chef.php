...
<?php
session_start();
if (isset($_SESSION['username']) && isset($_SESSION['password']) && isset($_SESSION['specialite'])) { ?>
    <form name="form12" method="POST" action="delete-matiere.php">
<br />
<br />
<br />
  ...
  <tr>
    <td><h1 align="center" class="heading"><img src="images/di.png" width="304" height="42" /></h1>
      ...
      <p align="center"><h1>
        ...
        Bienvenu: <?php echo " " . $_SESSION['username'];?><br/>
          </h1>
       <table>
	    <tr>
<ol>
