...
if($_POST['question16']=="r4"){
    $_SESSION['cor16']=$_POST['16r4'] ;   
}
if($_POST['question16']=="r3"){
    $_SESSION['cor16']=$_POST['16r3'] ;   
}
if($_POST['question16']=="r2"){
    $_SESSION['cor16']=$_POST['16r2'] ;   
}
if($_POST['question16']=="r1"){
    $_SESSION['cor16']=$_POST['16r1'] ;   
}}
if (isset($_POST['question17'])){
if($_POST['question17']=="r4"){
    $_SESSION['cor17']=$_POST['17r4'] ;   
}
if($_POST['question17']=="r3"){
    $_SESSION['cor17']=$_POST['17r3'] ;   
}
if($_POST['question17']=="r2"){
    $_SESSION['cor17']=$_POST['17r2'] ;   
}
if($_POST['question17']=="r1"){
    $_SESSION['cor17']=$_POST['17r1'] ;   
}}
if (isset($_POST['question18'])){
if($_POST['question18']=="r4"){
    $_SESSION['cor18']=$_POST['18r4'] ;   
}
if($_POST['question18']=="r3"){
    $_SESSION['cor18']=$_POST['18r3'] ;   
}
if($_POST['question18']=="r2"){
    $_SESSION['cor18']=$_POST['18r2'] ;   
}
if($_POST['question18']=="r1"){
    $_SESSION['cor18']=$_POST['18r1'] ;   
}
if($_POST['question18']=="r4"){
    $_SESSION['cor18']=$_POST['18r4'] ;   
}}
if (isset($_POST['question9'])){
if($_POST['question19']=="r4"){
    $_SESSION['cor19']=$_POST['19r4'] ;   
}
if($_POST['question19']=="r3"){
    $_SESSION['cor19']=$_POST['19r3'] ;   
}
if($_POST['question19']=="r2"){
    $_SESSION['cor19']=$_POST['19r2'] ;   
}
if($_POST['question19']=="r1"){
    $_SESSION['cor19']=$_POST['19r1'] ;   
}}
if (isset($_POST['question20'])){
if($_POST['question20']=="r4"){
    $_SESSION['cor20']=$_POST['20r4'] ;   
}
if($_POST['question20']=="r3"){
    $_SESSION['cor20']=$_POST['20r3'] ;   
}
if($_POST['question20']=="r2"){
    $_SESSION['cor20']=$_POST['20r2'] ;   
}
if($_POST['question20']=="r1"){
    $_SESSION['cor20']=$_POST['20r1'] ;   
}}
...
$r163=$_POST['16r3'] ;
$r164=$_POST['16r4'] ;
if(isset($_SESSION['cor16'])){
$rep16=$_SESSION['cor16'] ;}
...
$r173=$_POST['17r3'] ;
$r174=$_POST['17r4'] ;
if(isset($_SESSION['cor17'])){
$rep17=$_SESSION['cor17'] ;}
...
$r183=$_POST['18r3'] ;
$r184=$_POST['18r4'] ;
if(isset($_SESSION['cor18'])){
$rep18=$_SESSION['cor18'] ;}
...
$r193=$_POST['19r3'] ;
$r194=$_POST['19r4'] ;
if(isset($_SESSION['cor19'])){
$rep19=$_SESSION['cor19'] ;}
...
$r203=$_POST['20r3'] ;
$r204=$_POST['20r4'] ;
if(isset($_SESSION['cor20'])){
$rep20=$_SESSION['cor20'] ;}
...
$query16="INSERT INTO `online`.`question` (`id`, `reponse1`, `reponse2`, `reponse3`, `reponse4`, `correct`, `question`) VALUES ('$co', '$r161', '$r162', '$r163', '$r164', '$rep16' ,'$q16')";
$query17="INSERT INTO `online`.`question` (`id`, `reponse1`, `reponse2`, `reponse3`, `reponse4`, `correct`, `question`) VALUES ('$co', '$r171', '$r172', '$r173', '$r174', '$rep17' ,'$q17')";
$query18="INSERT INTO `online`.`question` (`id`, `reponse1`, `reponse2`, `reponse3`, `reponse4`, `correct`, `question`) VALUES ('$co', '$r181', '$r182', '$r183', '$r184', '$rep18', '$q18' )";
$query19="INSERT INTO `online`.`question` (`id`, `reponse1`, `reponse2`, `reponse3`, `reponse4`, `correct`, `question`) VALUES ('$co', '$r191', '$r192', '$r193', '$r194', '$rep19', '$q19')";
$query20="INSERT INTO `online`.`question` (`id`, `reponse1`, `reponse2`, `reponse3`, `reponse4`, `correct`, `question`) VALUES ('$co', '$r201', '$r202', '$r203', '$r204', '$rep20', '$q20')";
mysql_query($query1);
mysql_query($query2);
mysql_query($query3);
mysql_query($query4);
