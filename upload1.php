    ...
    <td><h1 align="center" class="heading"><img src="images/di.png" width="304" height="42" /></h1>
      ...
      <p align="center"><h1>
            ...
            <form method="POST" action="upload.php" enctype="multipart/form-data">
                <div align="left">
                <b><div style="color:#01471A">examen<input name="examen" type="file"></div></b>&nbsp;
                <br/><br/>
                <b><div style="color:#01471A">Correction :<input name="correction" type="file"></div></b>&nbsp;<br/><br/>
                <b><div style="color:#01471A">Type :<select name="s1"><option>partiel</option>
                <option>final</option>
                </select></div></b><br/><br/>
                <b><div style="color:#01471A">Anne :<input name="anne" type="text" maxlength="4"></div></b><br/><br/>
                <?php
                $_SESSION['specialite']=$_POST['sp'];
