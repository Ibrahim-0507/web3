...
if (isset($_SESSION['username']) && isset($_SESSION['password'])) { ?>
    <form name="form12" method="POST" action="ajoute-matiere.php">
<br />
<br />
<br />
  ...
  <tr>
    <td><h1 align="center" class="heading"><img src="images/di.png" width="304" height="42" /></h1>
      ...
      <p align="center"><h1>
        ...
        Bienvenu: <?php echo " " . $_SESSION['username']; $ses=$_SESSION['specialite'];?>
          </h1>
       <table>
	    <tr>
<ol>
...
<p align="left">&nbsp;</p></td>
      ...
      <input type="hidden" value="<?php echo $ses; ?>" name="ses">
